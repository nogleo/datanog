...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.openbttn, 0, 0, 1, 1)
        self.plotLayout = QtWidgets.QVBoxLayout()
        self.plotLayout.setObjectName("plotLayout")
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.plotLayout.addItem(spacerItem)
        self.gridLayout_2.addLayout(self.plotLayout, 1, 1, 2, 1)
        self.dataLayout = QtWidgets.QVBoxLayout()
        self.dataLayout.setObjectName("dataLayout")
        self.processbttn = QtWidgets.QPushButton(self.tab_2)
        self.processbttn.setObjectName("processbttn")
        self.dataLayout.addWidget(self.processbttn)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.dataLayout.addItem(spacerItem1)
        self.gridLayout_2.addLayout(self.dataLayout, 1, 0, 2, 1)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.plotbttn = QtWidgets.QPushButton(self.tab_2)
        self.plotbttn.setObjectName("plotbttn")
        self.horizontalLayout.addWidget(self.plotbttn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.processbttn.setText(_translate("MainWindow", "Process"))
        self.plotbttn.setText(_translate("MainWindow", "Plot"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Process"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Spectral"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Time-Frequency"))
